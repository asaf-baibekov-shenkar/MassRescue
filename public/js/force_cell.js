		...
		return `
			<div index="${this.force.force_id}" class="cell shadow-lg d-flex align-items-center justify-content-between bg-light p-3 border-bottom border-dark">
				...
				<div class="d-flex align-items-center">
					...
					<a class="btn_edit btn btn-light border border-1 border-dark p-0 ms-3 d-flex justify-content-center align-items-center" style="height: 38px; width: 38px">
					...
					<a class="btn_close btn btn-light border border-1 border-dark p-0 ms-3 d-flex justify-content-center align-items-center" style="height: 38px; width: 38px">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg">
