<?php $json = json_decode($data['forces'], true)["forces"]; ?>
...
<div index="<?php echo $object["force_id"]; ?>" class="cell shadow-lg d-flex align-items-center justify-content-between bg-light p-3 border-bottom border-dark">
	...
	<div class="d-flex align-items-center">
		<div class="h-100 d-flex flex-column me-3 align-items-center">
			...
			<span>
				<?php echo number_format($object["latitude"], 5, '.', ","); ?>
			</span>
			<span>
				<?php echo number_format($object["longitude"], 5, '.', ","); ?>
			</span>
		</div>
		<img src="<?php echo ICONS_PATH . 'location-icon.svg' ?>" alt="" width="18px" height="24px">
